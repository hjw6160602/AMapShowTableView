...
-(BOOL) addFileToZip:(NSString*) file newname:(NSString*) newname;
{
    ...
    //NSDictionary* attr = [[NSFileManager defaultManager] fileAttributesAtPath:file traverseLink:YES]; iOS2.0之后被弃用的方法
...
-(BOOL) UnzipOpenFile:(NSString*) zipFile
{
    ...
    if( _unzFile )
    {
        ...
        {
            NSString *globalInfo_number_entry = [[NSString alloc]initWithFormat:@"压缩文档中共有%lu个文件",globalInfo.number_entry];
            NSLog(@"%@",globalInfo_number_entry);
        }
    }
